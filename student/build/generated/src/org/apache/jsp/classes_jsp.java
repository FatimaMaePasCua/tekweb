  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(request.getParameter("ayd") != null){
        if(session.getAttribute("ayd") == null){
            try{
            Connection con = DriverManager.getConnection("jdbc:mysql://192.168.7.14:3306/tekweb","root","");
        ...
        response.sendRedirect("http://192.168.7.14/tekweb/index.php");
    }
      ...
      out.write("                                <h4 class=\"card-title text-center\">My Classes</h4>\n");
      out.write("                            </div>\n");
      ...
      out.write("                                        <th>Prelim Grade</th>\n");
      out.write("                                        <th>Midterm Grade</th>\n");
      ...
      out.write("                                            ");
                                                ...
                                                if(!rs.next()){
                                                    ...
                                                    while(rs.next()){
                                                        ...
                                                        out.println("</td><td>" + "<a download href=http://192.168.7.14/tekweb/teacher/uploads/grades/"+ rs.getInt("studentclasses.classID") + "/" + rs.getString("Preliminary") + ">" + rs.getString("Preliminary") + "</a>");
                                                        out.println("</td><td>" + "<a download href=http://192.168.7.14/tekweb/teacher/uploads/grades/"+ rs.getInt("studentclasses.classID") + "/" +rs.getString("Midterms") + ">" + rs.getString("Midterms") + "</a>");
                                                        out.println("</td><td>" + "<a download href=http://192.168.7.14/tekweb/teacher/uploads/grades/"+ rs.getInt("studentclasses.classID") + "/" +rs.getString("Finals") + ">" + rs.getString("Finals") + "</a>");
                                                        out.println("</td></tr>");
      ...
      out.write("                        <div class=\"card\">\n");
      out.write("                            <div class=\"card-header card-header-primary\">\n");
      out.write("                                <h4 class=\"card-title text-center\">Class Invitations</h4>\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"card-body\">\n");
      out.write("                                <div class=\"table-responsive\">\n");
      out.write("                                    <table class=\"table\">\n");
